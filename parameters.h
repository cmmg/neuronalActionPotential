...
#define dimH 0.01792                                      //used to define the thickness of myelin sheath
...
#define initialIntraConcA 150.0128                        //initial intra-cellular chloride ion concentration (mM) 
...
#define Total_time 15 //ms                                //total simulation time in milli-seconds
