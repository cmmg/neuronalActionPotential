...
//Basic framework for modeling action potential propagation in neurons using the double-cable model.
//Created May 2021
...
namespace elasticity1
{
  ...
  void elasticity<dim>::solve(const unsigned int increment){
    double res=1, tol=1.0e-7, abs_tol=1.0e-7, initial_norm=0, current_norm=0;
